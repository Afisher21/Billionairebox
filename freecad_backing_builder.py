...
PARAM_SPECS = [
    ...
    ("PerimeterWall", "3 mm", "Wall thickness around the open perimeter.", "ESTIMATED"),
    ("BackWall", "3 mm", "Thickness of the exterior back wall.", "ESTIMATED"),
    ...
    ("ScrewDriverDiameter", "10 mm", "Access shaft diameter for a typical screwdriver.", "ESTIMATED"),
    ...
    ("LegacyPCBWidth", "28 mm", "Width of the original PCB keep-out box.", "ESTIMATED"),
    ("LegacyPCBLength", "22 mm", "Height of the original PCB keep-out box.", "ESTIMATED"),
    ("LegacyPCBHeight", "10 mm", "Depth of the original PCB keep-out box.", "ESTIMATED"),
    ("AddonPCBX", "20 mm", "Left edge of the new PCB tray.", "ESTIMATED"),
    ("AddonPCBY", "84 mm", "Bottom edge of the new PCB tray.", "ESTIMATED"),
    ("AddonPCBWidth", "40 mm", "Board width for the new PCB tray.", "ESTIMATED"),
    ("AddonPCBLength", "50 mm", "Board height for the new PCB tray.", "ESTIMATED"),
    ("AddonPCBThickness", "1.8 mm", "Board thickness for the new PCB tray.", "ESTIMATED"),
